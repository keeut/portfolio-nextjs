...
const PlanDiaryText = (props) => (
    <div className={styles.container}>
        ...
        <p>React-dev-tool을 이용해 성능을 점검해보며 memo, useCallback을 이용하였습니다. <a target='_blank'rel="noreferrer" className={styles.a} href="https://keeut.tistory.com/7">블로그 글 확인</a></p>
